...
# --- Calculate Returns and Scores for each lookback ---
...
# --- Filter stocks with scores > 90 in all periods ---
...
# sorted_all_scores = all_scores.sort_values(by=['1M Score', '3M Score', '6M Score'], ascending=[False, False, False])
